...
if __name__ == "__main__":
    ...
    IMG_DIR = "./VOCnest/JPEGImages/"
    XML_DIR = "./VOCnest/Annotations/"

    AUG_XML_DIR = "./VOCnest/AUG/Annotations/"  # 存储增强后的XML文件夹路径
    try:
    ...
    AUG_IMG_DIR = "./VOCnest/AUG/JPEGImages/"  # 存储增强后的影像文件夹路径
    try:
